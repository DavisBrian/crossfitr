...
# Fix "Mike Boessling" Height (he's closer to 6 feet than 6 inches)
...
# ggplot(athletes, mapping = aes_string(x=variable, fill = "gender")) +
#   geom_histogram(aes(y=..density..),binwidth=1L, position="dodge") +
#   geom_density(alpha=.4,adjust=3, color=NA) +
#   scale_x_continuous(limits = limits,
#                      breaks = breaks,
#                      labels = labels) +
